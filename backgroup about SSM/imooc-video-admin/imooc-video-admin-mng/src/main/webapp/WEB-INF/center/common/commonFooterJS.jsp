...
<input type="hidden" id="apiServer" name="apiServer" value="http://172.22.190.49:8081"/>
<input type="hidden" id="bgmServer" name="bgmServer" value="http://172.22.190.49:8080/mvc"/>
